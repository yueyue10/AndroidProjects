...
import com.smartdot.mywebview.adapter.DragAdapter;
import com.smartdot.mywebview.utils.recyclerview.DividerGridItemDecoration;
import com.smartdot.mywebview.utils.recyclerview.DividerItemDecorationz;
...
public class DragRvActivity extends AppCompatActivity {
    ...
    private Context mContext = DragRvActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dragrv);
...
//        mRecyclerView.addItemDecoration(new DividerGridItemDecoration(this));
        mRecyclerView.addItemDecoration(new DividerItemDecorationz(this));

        myAdapter = new DragAdapter(datas, mContext);
...
//                datas.remove(position);
        ...
        alert_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DragRvActivity.this, datas.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
