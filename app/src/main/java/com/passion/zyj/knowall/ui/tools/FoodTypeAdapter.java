 ...
 * @date 2018/2/24
 */
public class FoodTypeAdapter extends BaseQuickAdapter<FoodBean, FoodTypeAdapter.ViewHolder> {

    public FoodTypeAdapter(int layoutResId, @Nullable List<FoodBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(FoodTypeAdapter.ViewHolder helper, FoodBean item) {
