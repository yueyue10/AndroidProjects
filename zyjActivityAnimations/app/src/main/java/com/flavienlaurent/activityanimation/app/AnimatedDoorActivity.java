...
public abstract class AnimatedDoorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("aaa:parent:height="
		...
		mDoorType = getIntent().getIntExtra("door_type",
				AnimatedDoorLayout.HORIZONTAL_DOOR);
		mAnimated.setDoorType(mDoorType);

		ObjectAnimator animator = ObjectAnimator.ofFloat(mAnimated,
				ANIMATED_DOOR_LAYOUT_FLOAT_PROPERTY, 2).setDuration(600);
		animator.start();
	}
	...
	public void onBackPressed() {
		ObjectAnimator animator = ObjectAnimator.ofFloat(mAnimated,
				ANIMATED_DOOR_LAYOUT_FLOAT_PROPERTY, 0).setDuration(600);
	...
	private static final Property<AnimatedDoorLayout, Float> ANIMATED_DOOR_LAYOUT_FLOAT_PROPERTY = new Property<AnimatedDoorLayout, Float>(
			Float.class, "ANIMATED_DOOR_LAYOUT_FLOAT_PROPERTY") {
