...
public class MainActivity extends Activity implements View.OnClickListener,
	...
	private Button fadein_fadeout;
	private Button inleft_outright;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fadein_fadeout.setOnClickListener(this);
		inleft_outright.setOnClickListener(this);
	...
	public void onClick(View view) {
		...
		} else if (view.getId() == R.id.fadein_fadeout) {
			intent = new Intent(this, TestActivity.class);
			overridePendingTransition(android.R.anim.fade_in,
					android.R.anim.fade_out);
		} else if (view.getId() == R.id.inleft_outright) {
			intent = new Intent(this, TestActivity.class);
	...
	private void findViews() {
		...
		fadein_fadeout = (Button) findViewById(R.id.fadein_fadeout);
		inleft_outright = (Button) findViewById(R.id.inleft_outright);
	}
